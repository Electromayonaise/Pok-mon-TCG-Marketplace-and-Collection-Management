...
- Business-application `legalIdentity` data is regulated personal data under Colombian Ley 1581 (habeas data), held as ordinary (not sensitive-category) personal data under standard consent rules: timestamped consent captured at submission, a published Privacy Policy with a designated rights-request contact, and admin-review-only access scoping — see `ARCHITECTURE-SPINE.md` AD-13. RNBD registration is not required at this company's asset scale.
